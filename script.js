...
function requestApi(city){
    api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=1d168f7ce2e9736124765094f1afd005`;
    fetchData();
}
...
function onError(error){
    // if any error occur while getting user location then show it in infoText
